...
virtual ~ADSREnvelope();
  ...
  void assignAttackAmplitudes(const int begin, const int end, std::vector<double>& amplitudes, const double a0, const double a1) const;
  void assignDecayAmplitudes(const int begin, const int end, std::vector<double>& amplitudes, const double a0, const double a1) const;
  void assignSustainAmplitudes(const int begin, const int end, std::vector<double>& amplitudes, const double a0) const;  
  void assignReleaseAmplitudes(const int begin, const int end, std::vector<double>& amplitudes, const double a0, const double a1) const;
