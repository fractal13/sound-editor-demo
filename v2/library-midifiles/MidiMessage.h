...
class MidiMessage : public std::vector<uchar> {
	...
	public:
		...
		void           makeMts9_TemperamentByCentsDeviationFromET (std::vector<double>& mapping, int referencePitchClass = 0, int channelMask = 0xFFFF);
		void           makeTemperamentEqual(int referencePitchClass = 0, int channelMask = 0xFFFF);
		void           makeTemperamentBad(double maxDeviationCents = 100.0, int referencePitchClass = 0, int channelMask = 0xFFFF);
		void           makeTemperamentPythagorean(int referencePitchClass = 2, int channelMask = 0xFFFF);
		void           makeTemperamentMeantone(double fraction = 0.25, int referencePitchClass = 2, int channelMask = 0xFFFF);
		void           makeTemperamentMeantoneCommaQuarter(int referencePitchClass = 2, int channelMask = 0xFFFF);
		void           makeTemperamentMeantoneCommaThird(int referencePitchClass = 2, int channelMask = 0xFFFF);
		void           makeTemperamentMeantoneCommaHalf(int referencePitchClass = 2, int channelMask = 0xFFFF);
